...
class Num_Theory
{
    ...
    ArrayList<Integer> Aliquot_Seq(int num)throws IOException
    {
        //Definiton

        //Aliquot sequence is a sequence of positive integers where every term is the summation of
        //proper divisors of the previous term.
        //If the sequence reaches number = 1,it stops as the sum for 1 is 0.

        ArrayList<Integer> arr = new ArrayList<>();

        System.out.println("\n\n\t\t\tAliquot Sequence");
        System.out.println("\nDefinition: Aliquot sequence is a sequence of positive integers where every term is the summation of proper divisors of the previous term. If the sequence reaches number = 1,it stops as the sum for 1 is 0.");
        ...
        int l, sum = 0, num_nxt = num, cnt = 0;
        System.out.print("\nThe Aliquot Sequence of " + num + " : "+ num_nxt + " ");
        arr.add(num_nxt);
