...
public class Num_TheoryTest {
    ...
    public void testAliquot_Seq_1() throws Exception {
        assertEquals(new ArrayList<>(Arrays.asList(156, 236, 184, 176, 196, 203, 37, 1, 0)), num_theoryUnderTest.Aliquot_Seq(156));
    }

    @Test
    public void testAliquot_Seq_2() throws Exception {
        assertEquals(new ArrayList<>(Arrays.asList(1, 0)), num_theoryUnderTest.Aliquot_Seq(1));
    }


    @Test
    public void testAliquot_Seq_3() throws Exception {
        assertEquals(new ArrayList<>(Arrays.asList()), num_theoryUnderTest.Aliquot_Seq(0));
    }

    @Test
    public void testAliquot_Seq_4() throws Exception {
        assertEquals(new ArrayList<>(Arrays.asList(14256, 30756, 47868, 63852, 94404, 125900, 147520, 204524, 153400, 237200, 333634)), num_theoryUnderTest.Aliquot_Seq(14256));
    }

    @Test
    public void testAliquot_Seq_5() throws Exception {
        assertEquals(new ArrayList<>(Arrays.asList(10, 8, 7, 1, 0)), num_theoryUnderTest.Aliquot_Seq(10));
    }
